...
const Login = () => {
    ...
    const [formData, setFormData] = useState({ countryCode: '+91', phone: '', password: '' });
    ...
    return (
        <AuthLayout title="Enter phone number" subtitle="Select a country and enter your phone number.">
            <form onSubmit={handleSubmit} className="space-y-6 max-w-sm mx-auto">
                <div className="space-y-4">
                    ...
                    {/* Password Input (Login needs pass) */}
                ...
                <div className="pt-4 flex flex-col items-center gap-4">
                    ...
                    <div className="flex gap-4 text-xs">
                        <Link to="/signup" className="text-[#008069] font-medium hover:underline">
                            Sign up
                        </Link>
                        <Link to="/forgot-password" className="text-[#008069] font-medium hover:underline">
                            Forgot password?
                        </Link>
                    </div>
                </div>
